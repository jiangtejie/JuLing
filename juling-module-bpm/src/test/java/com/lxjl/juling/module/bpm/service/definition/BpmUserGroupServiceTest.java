...
import com.lxjl.juling.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import com.lxjl.juling.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import com.lxjl.juling.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.lxjl.juling.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.lxjl.juling.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("土豆")));
       // 测试 status 不匹配
