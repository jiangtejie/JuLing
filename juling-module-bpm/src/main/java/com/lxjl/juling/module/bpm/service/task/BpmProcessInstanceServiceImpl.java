package com.lxjl.juling.module.bpm.service.task;
...
import com.lxjl.juling.framework.common.util.date.DateUtils;
...
import com.lxjl.juling.framework.common.util.object.PageUtils;
...
import com.lxjl.juling.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.lxjl.juling.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.lxjl.juling.module.bpm.controller.admin.task.vo.instance.*;
import com.lxjl.juling.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.lxjl.juling.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.lxjl.juling.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.lxjl.juling.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.lxjl.juling.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.lxjl.juling.module.bpm.enums.ErrorCodeConstants;
import com.lxjl.juling.module.bpm.enums.definition.BpmModelTypeEnum;
import com.lxjl.juling.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.lxjl.juling.module.bpm.enums.task.BpmAttachmentTypeEnum;
import com.lxjl.juling.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.lxjl.juling.module.bpm.enums.task.BpmReasonEnum;
import com.lxjl.juling.module.bpm.enums.task.BpmTaskStatusEnum;
import com.lxjl.juling.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.lxjl.juling.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.lxjl.juling.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.lxjl.juling.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.lxjl.juling.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.lxjl.juling.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.lxjl.juling.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.lxjl.juling.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.lxjl.juling.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.lxjl.juling.module.bpm.service.definition.BpmProcessDefinitionService;
import com.lxjl.juling.module.bpm.service.message.BpmMessageService;
...
import static com.lxjl.juling.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.lxjl.juling.module.bpm.enums.ErrorCodeConstants.*;
import static com.lxjl.juling.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.lxjl.juling.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    public BpmApprovalDetailRespVO getApprovalDetail(Long loginUserId, BpmApprovalDetailReqVO reqVO) {
        ...
        // 特殊：如果是未发起的场景，则设置发起用户，解决“发起流程”时，需要使用到该变量的问题。例如说：上游社区讨论
        if (historicProcessInstance == null) {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://github.com/jiangtejie/JuLing
