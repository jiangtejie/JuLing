package com.lxjl.juling.module.bpm.controller.admin.task.vo.instance;
...
public class BpmApprovalDetailRespVO {
    ...
    public static class ActivityNodeTask {
        ...
        @Schema(description = "签名", example = "https://github.com/jiangtejie/JuLing")
        private String signPicUrl;

        @Schema(description = "附件", example = "[https://example.com/file]")
