...
import com.lxjl.juling.framework.test.core.util.AssertUtils;
import com.lxjl.juling.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import com.lxjl.juling.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import com.lxjl.juling.module.infra.dal.dataobject.file.FileDO;
import com.lxjl.juling.module.infra.dal.mysql.file.FileMapper;
...
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.FILE_PATH_INVALID;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileByPresignedPath_success() {
        ...
        FileCreateReqVO reqVO = randomPojo(FileCreateReqVO.class, o -> {
            ...
            o.setName("test.jpg");
            o.setUrl("https://github.com/jiangtejie/JuLing");
        });
        ...
        assertEquals("https://github.com/jiangtejie/JuLing", file.getUrl());
    }
