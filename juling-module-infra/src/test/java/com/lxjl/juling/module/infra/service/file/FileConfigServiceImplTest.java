package com.lxjl.juling.module.infra.service.file;
...
import com.lxjl.juling.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.lxjl.juling.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.lxjl.juling.module.infra.dal.dataobject.file.FileConfigDO;
import com.lxjl.juling.module.infra.dal.mysql.file.FileConfigMapper;
import com.lxjl.juling.module.infra.framework.file.core.client.FileClient;
import com.lxjl.juling.module.infra.framework.file.core.client.FileClientConfig;
import com.lxjl.juling.module.infra.framework.file.core.client.FileClientFactory;
import com.lxjl.juling.module.infra.framework.file.core.client.local.LocalFileClient;
import com.lxjl.juling.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.lxjl.juling.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        // 准备参数
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/juling")
                .put("domain", "https://github.com/jiangtejie/JuLing").build();
        ...
        assertEquals("/juling", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://github.com/jiangtejie/JuLing", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/juling").setDomain("https://github.com/jiangtejie/JuLing")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/juling2")
                    .put("domain", "https://github.com/jiangtejie/JuLing#readme").build();
            o.setConfig(config);
        });
        ...
        assertEquals("/juling2", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://github.com/jiangtejie/JuLing#readme", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("棱信矩灵")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://github.com/jiangtejie/JuLing");

        // 调用，并断言
        assertEquals("https://github.com/jiangtejie/JuLing", fileConfigService.testFileConfig(id));
    }
