...
import com.lxjl.juling.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.lxjl.juling.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.lxjl.juling.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.lxjl.juling.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("juling-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("juling-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @棱信矩灵：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
