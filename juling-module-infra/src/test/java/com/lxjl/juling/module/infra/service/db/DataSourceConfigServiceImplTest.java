package com.lxjl.juling.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import com.lxjl.juling.framework.mybatis.core.type.EncryptTypeHandler;
import com.lxjl.juling.framework.mybatis.core.util.JdbcUtils;
import com.lxjl.juling.framework.test.core.ut.BaseDbUnitTest;
import com.lxjl.juling.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import com.lxjl.juling.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.lxjl.juling.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static com.lxjl.juling.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("juling");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("juling", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("juling", dataSourceConfigList.get(0).getUsername());
