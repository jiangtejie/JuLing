package com.lxjl.juling.module.infra.controller.admin.config.vo;
...
public class ConfigSaveReqVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "juling.db.username")
