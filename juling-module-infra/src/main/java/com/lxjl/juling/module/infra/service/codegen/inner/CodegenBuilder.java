...
import com.lxjl.juling.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import com.lxjl.juling.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link com.lxjl.juling.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.example.com/1.png");
            return;
        }
        // reason
