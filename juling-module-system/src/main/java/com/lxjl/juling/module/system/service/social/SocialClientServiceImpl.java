package com.lxjl.juling.module.system.service.social;
...
import com.lxjl.juling.framework.common.util.cache.CacheUtils;
import com.lxjl.juling.framework.common.util.http.HttpUtils;
import com.lxjl.juling.framework.common.util.object.BeanUtils;
import com.lxjl.juling.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.lxjl.juling.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.lxjl.juling.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.lxjl.juling.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.lxjl.juling.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
import com.lxjl.juling.module.system.controller.admin.social.vo.client.SocialClientSaveReqVO;
import com.lxjl.juling.module.system.dal.dataobject.social.SocialClientDO;
import com.lxjl.juling.module.system.dal.mysql.social.SocialClientMapper;
import com.lxjl.juling.module.system.dal.redis.RedisKeyConstants;
import com.lxjl.juling.module.system.enums.social.SocialTypeEnum;
import com.lxjl.juling.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.lxjl.juling.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.lxjl.juling.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${juling.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${juling.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://github.com/jiangtejie/JuLing
