package com.lxjl.juling.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "juling")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://github.com/jiangtejie/JuLing")
