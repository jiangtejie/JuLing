package com.lxjl.juling.module.system.controller.admin.user.vo.user;

import cn.hutool.core.util.ObjectUtil;
import com.lxjl.juling.framework.common.validation.Mobile;
import com.lxjl.juling.module.system.framework.operatelog.core.DeptParseFunction;
import com.lxjl.juling.module.system.framework.operatelog.core.PostParseFunction;
import com.lxjl.juling.module.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "juling")
    ...
    @Schema(description = "用户邮箱", example = "juling@example.com")
