...
import com.lxjl.juling.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
...
import com.lxjl.juling.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 juling.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
    ...
    @DataPermission(enable = false) // 参见 https://github.com/jiangtejie/JuLing 说明
