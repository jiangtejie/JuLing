package com.lxjl.juling.module.system.controller.admin.auth;
...
import com.lxjl.juling.module.system.service.auth.AdminAuthService;
...
import com.lxjl.juling.module.system.service.social.SocialClientService;
...
public class AuthController {
    ...
    @DataPermission(enable = false) // 忽略数据权限，避免因为过滤，导致无法查询用户。类似：上游社区讨论
