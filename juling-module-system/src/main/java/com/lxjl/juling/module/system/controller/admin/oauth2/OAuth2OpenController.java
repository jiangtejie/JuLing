...
import com.lxjl.juling.framework.common.util.http.HttpUtils;
...
import com.lxjl.juling.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.lxjl.juling.module.system.util.oauth2.OAuth2Utils;
...
import static com.lxjl.juling.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://github.com/jiangtejie/JuLing"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://github.com/jiangtejie/JuLing"),
