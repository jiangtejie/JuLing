package com.lxjl.juling.module.system.service.dict;
...
import com.lxjl.juling.module.system.controller.admin.dict.vo.data.DictDataPageReqVO;
import com.lxjl.juling.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import com.lxjl.juling.module.system.dal.dataobject.dict.DictDataDO;
import com.lxjl.juling.module.system.dal.dataobject.dict.DictTypeDO;
import com.lxjl.juling.module.system.dal.mysql.dict.DictDataMapper;
...
public class DictDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDictDataList() {
        // mock 数据
        DictDataDO dictDataDO01 = randomDictDataDO().setDictType("juling").setSort(2)
                .setStatus(CommonStatusEnum.ENABLE.getStatus());
        dictDataMapper.insert(dictDataDO01);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("juling").setSort(1)
                .setStatus(CommonStatusEnum.ENABLE.getStatus());
        dictDataMapper.insert(dictDataDO02);
        DictDataDO dictDataDO03 = randomDictDataDO().setDictType("juling").setSort(3)
                .setStatus(CommonStatusEnum.DISABLE.getStatus());
        dictDataMapper.insert(dictDataDO03);
        DictDataDO dictDataDO04 = randomDictDataDO().setDictType("juling2").setSort(3)
                .setStatus(CommonStatusEnum.DISABLE.getStatus());
        dictDataMapper.insert(dictDataDO04);
        // 准备参数
        Integer status = CommonStatusEnum.ENABLE.getStatus();
        String dictType = "juling";
    ...
    public void testGetDictDataPage() {
        ...
        // 测试 label 不匹配
        dictDataMapper.insert(cloneIgnoreId(dbDictData, o -> o.setLabel("李")));
        // 测试 dictType 不匹配
    ...
    public void testGetDictDataCountByDictType() {
        // mock 数据
        dictDataMapper.insert(randomDictDataDO(o -> o.setDictType("juling")));
    ...
    public void testGetDictData_dictType() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("juling").setValue("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("juling").setValue("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "juling";
        String value = "1";
    ...
    public void testParseDictData() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("juling").setLabel("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("juling").setLabel("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "juling";
        String label = "1";
