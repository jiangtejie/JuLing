...
import com.lxjl.juling.module.system.controller.admin.logger.vo.loginlog.LoginLogPageReqVO;
import com.lxjl.juling.module.system.dal.dataobject.logger.LoginLogDO;
import com.lxjl.juling.module.system.dal.mysql.logger.LoginLogMapper;
...
import static com.lxjl.juling.module.system.enums.logger.LoginResultEnum.CAPTCHA_CODE_ERROR;
import static com.lxjl.juling.module.system.enums.logger.LoginResultEnum.SUCCESS;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        // 测试 username 不匹配
        loginLogMapper.insert(cloneIgnoreId(loginLogDO, o -> o.setUsername("juling")));
        // 测试 createTime 不匹配
