package com.lxjl.juling.module.system.service.tenant;

import com.lxjl.juling.framework.common.enums.CommonStatusEnum;
import com.lxjl.juling.framework.common.pojo.PageResult;
import com.lxjl.juling.framework.tenant.config.TenantProperties;
...
import com.lxjl.juling.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.lxjl.juling.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.lxjl.juling.module.system.dal.dataobject.permission.MenuDO;
...
import com.lxjl.juling.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.lxjl.juling.module.system.dal.mysql.tenant.TenantMapper;
import com.lxjl.juling.module.system.enums.permission.RoleCodeEnum;
import com.lxjl.juling.module.system.enums.permission.RoleTypeEnum;
import com.lxjl.juling.module.system.service.permission.MenuService;
...
import com.lxjl.juling.module.system.service.tenant.handler.TenantInfoHandler;
import com.lxjl.juling.module.system.service.tenant.handler.TenantMenuHandler;
import com.lxjl.juling.module.system.service.user.AdminUserService;
...
import static com.lxjl.juling.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsites(singletonList("https://github.com/jiangtejie/JuLing"));
            o.setUsername("juling");
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsites(singletonList("https://github.com/jiangtejie/JuLing")));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://github.com/jiangtejie/JuLing");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
