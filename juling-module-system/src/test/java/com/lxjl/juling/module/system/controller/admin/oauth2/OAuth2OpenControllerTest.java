package com.lxjl.juling.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.lxjl.juling.framework.common.core.KeyValue;
...
import com.lxjl.juling.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.lxjl.juling.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.lxjl.juling.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.lxjl.juling.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.lxjl.juling.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.lxjl.juling.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.lxjl.juling.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.lxjl.juling.module.system.service.oauth2.OAuth2ApproveService;
import com.lxjl.juling.module.system.service.oauth2.OAuth2ClientService;
import com.lxjl.juling.module.system.service.oauth2.OAuth2GrantService;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://github.com/jiangtejie/JuLing";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://github.com/jiangtejie/JuLing#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://github.com/jiangtejie/JuLing#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://github.com/jiangtejie/JuLing#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://github.com/jiangtejie/JuLing?code=test_code&state=test", result.getData());
    }
