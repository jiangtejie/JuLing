package com.lxjl.juling.module.system.service.permission;
...
import com.lxjl.juling.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.lxjl.juling.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.lxjl.juling.module.system.dal.dataobject.permission.MenuDO;
import com.lxjl.juling.module.system.dal.mysql.permission.MenuMapper;
import com.lxjl.juling.module.system.enums.permission.MenuTypeEnum;
...
import static com.lxjl.juling.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("棱信矩灵").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setStatus(CommonStatusEnum.DISABLE.getStatus())));
        // 测试 name 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setName("李")));
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("矩灵").setStatus(CommonStatusEnum.ENABLE.getStatus());
