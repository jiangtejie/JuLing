package com.lxjl.juling.module.system.service.mail;
...
import com.lxjl.juling.framework.test.core.util.RandomUtils;
import com.lxjl.juling.module.system.dal.dataobject.mail.MailAccountDO;
import com.lxjl.juling.module.system.dal.dataobject.mail.MailTemplateDO;
import com.lxjl.juling.module.system.dal.dataobject.user.AdminUserDO;
import com.lxjl.juling.module.system.mq.message.mail.MailSendMessage;
import com.lxjl.juling.module.system.mq.producer.mail.MailProducer;
...
//                .setFrom("奥特曼 <ydym_test@163.com>")
    ...
    public void testDoSendMail_success() {
        try (final MockedStatic<MailUtil> mailUtilMock = mockStatic(MailUtil.class)) {
            // 准备参数
            MailSendMessage message = randomPojo(MailSendMessage.class, o -> o.setNickname("棱信矩灵"));
            // mock 方法（获得邮箱账号）
            ...
            mailUtilMock.when(() -> MailUtil.send(
                    argThat(mailAccount -> {
                        assertEquals("棱信矩灵 <7685@qq.com>", mailAccount.getFrom());
