package com.lxjl.juling.module.system.service.user;
...
import com.lxjl.juling.module.infra.api.config.ConfigApi;
import com.lxjl.juling.module.infra.api.file.FileApi;
import com.lxjl.juling.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.lxjl.juling.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.lxjl.juling.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.lxjl.juling.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.lxjl.juling.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.lxjl.juling.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.lxjl.juling.module.system.dal.dataobject.dept.DeptDO;
import com.lxjl.juling.module.system.dal.dataobject.dept.PostDO;
import com.lxjl.juling.module.system.dal.dataobject.dept.UserPostDO;
import com.lxjl.juling.module.system.dal.dataobject.tenant.TenantDO;
import com.lxjl.juling.module.system.dal.dataobject.user.AdminUserDO;
import com.lxjl.juling.module.system.dal.mysql.dept.UserPostMapper;
import com.lxjl.juling.module.system.dal.mysql.user.AdminUserMapper;
import com.lxjl.juling.module.system.enums.common.SexEnum;
import com.lxjl.juling.module.system.mq.producer.user.AdminUserProducer;
import com.lxjl.juling.module.system.service.dept.DeptService;
import com.lxjl.juling.module.system.service.dept.PostService;
import com.lxjl.juling.module.system.service.oauth2.OAuth2TokenService;
import com.lxjl.juling.module.system.service.permission.PermissionService;
import com.lxjl.juling.module.system.service.tenant.TenantService;
...
import static com.lxjl.juling.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
...
import static com.lxjl.juling.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("julingyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("julingyuanma");
        ...
        assertEquals("julingyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("julingyuanma"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("张三"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
