package com.lxjl.juling.module.wms.controller.admin.order.movement.vo.order;
...
import com.lxjl.juling.module.wms.enums.DictTypeConstants;
...
public class WmsMovementOrderRespVO {
    ...
    @Schema(description = "创建者名称", example = "矩灵")
    ...
    @Schema(description = "更新者名称", example = "矩灵")
