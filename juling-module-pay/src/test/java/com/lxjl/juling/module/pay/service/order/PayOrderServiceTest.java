package com.lxjl.juling.module.pay.service.order;

import cn.hutool.extra.spring.SpringUtil;
import com.lxjl.juling.framework.common.pojo.PageResult;
import com.lxjl.juling.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.lxjl.juling.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.lxjl.juling.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.lxjl.juling.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.lxjl.juling.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.lxjl.juling.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import com.lxjl.juling.module.pay.dal.dataobject.app.PayAppDO;
...
import com.lxjl.juling.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.lxjl.juling.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.lxjl.juling.module.pay.dal.mysql.order.PayOrderMapper;
import com.lxjl.juling.module.pay.dal.redis.no.PayNoRedisDAO;
import com.lxjl.juling.module.pay.enums.PayChannelEnum;
import com.lxjl.juling.module.pay.enums.notify.PayNotifyTypeEnum;
import com.lxjl.juling.module.pay.enums.order.PayOrderStatusEnum;
import com.lxjl.juling.module.pay.framework.pay.config.PayProperties;
import com.lxjl.juling.module.pay.framework.pay.core.client.PayClient;
import com.lxjl.juling.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.lxjl.juling.module.pay.framework.pay.core.enums.PayOrderDisplayModeEnum;
import com.lxjl.juling.module.pay.service.app.PayAppService;
import com.lxjl.juling.module.pay.service.channel.PayChannelService;
import com.lxjl.juling.module.pay.service.notify.PayNotifyService;
...
import static com.lxjl.juling.framework.common.util.date.LocalDateTimeUtils.*;
import static com.lxjl.juling.framework.common.util.json.JsonUtils.toJsonString;
...
import static com.lxjl.juling.module.pay.enums.ErrorCodeConstants.*;
...
public class PayOrderServiceTest extends BaseDbAndRedisUnitTest {
    ...
    public void testSubmitOrder_expired() {
        ...
        PayOrderDO order = randomPojo(PayOrderDO.class, o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus())
                .setExpireTime(addTime(Duration.ofDays(-1)).truncatedTo(ChronoUnit.MICROS)));
        orderMapper.insert(order);
        // 准备参数
        PayOrderSubmitReqVO reqVO = randomPojo(PayOrderSubmitReqVO.class, o -> o.setId(order.getId()));
        String userIp = randomString();
    ...
    public void testSubmitOrder_channelNotFound() {
        // mock 数据（order）
        PayOrderDO order = randomPojo(PayOrderDO.class, o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus())
                .setAppId(1L).setExpireTime(addTime(Duration.ofDays(1)).truncatedTo(ChronoUnit.MICROS)));
        orderMapper.insert(order);
        // 准备参数
        PayOrderSubmitReqVO reqVO = randomPojo(PayOrderSubmitReqVO.class, o -> o.setId(order.getId())
