...
import static com.lxjl.juling.module.pay.framework.pay.core.client.impl.weixin.AbstractWxPayClient.formatDateV3;
...
//        config.setCertSerialNo(serialNo);
        config.setPrivateCertPath("/tmp/juling-path");
        config.setPrivateKeyPath("/tmp/juling-path");
        return config;
    }
