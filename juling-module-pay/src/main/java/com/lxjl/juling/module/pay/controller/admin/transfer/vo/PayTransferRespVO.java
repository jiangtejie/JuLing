package com.lxjl.juling.module.pay.controller.admin.transfer.vo;
...
public class PayTransferRespVO {
    ...
    @ExcelProperty("应用名称")
    @Schema(description = "应用名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "棱信矩灵")
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://github.com/jiangtejie/JuLing")
