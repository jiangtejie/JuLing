package com.lxjl.juling.module.pay.service.wallet;
...
import com.lxjl.juling.module.pay.controller.app.wallet.vo.recharge.AppPayWalletRechargeCreateReqVO;
...
import com.lxjl.juling.module.pay.dal.dataobject.wallet.PayWalletRechargePackageDO;
import com.lxjl.juling.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
...
import static com.lxjl.juling.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.lxjl.juling.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.lxjl.juling.module.pay.enums.ErrorCodeConstants.*;
import static com.lxjl.juling.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.lxjl.juling.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @棱信矩灵：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
    ...
    private PayWalletDO validateWalletRechargeCanRefund(PayWalletRechargeDO walletRecharge) {
        ...
        // TODO @棱信矩灵：需要考虑下，赠送的金额，会不会导致提现超过；
        return wallet;
    }
