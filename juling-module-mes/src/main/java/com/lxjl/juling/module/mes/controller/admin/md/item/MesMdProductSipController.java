...
import com.lxjl.juling.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipPageReqVO;
import com.lxjl.juling.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipRespVO;
import com.lxjl.juling.module.mes.controller.admin.md.item.vo.sip.MesMdProductSipSaveReqVO;
import com.lxjl.juling.module.mes.dal.dataobject.md.item.MesMdProductSipDO;
import com.lxjl.juling.module.mes.service.md.item.MesMdProductSipService;
...
public class MesMdProductSipController {
    ...
    public CommonResult<PageResult<MesMdProductSipRespVO>> getProductSipPage(@Valid MesMdProductSipPageReqVO pageReqVO) {
        ...
        // TODO @棱信矩灵：工序模块实现后，补充 processCode/processName 的 JOIN 逻辑
