...
import com.lxjl.juling.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import com.lxjl.juling.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import com.lxjl.juling.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import com.lxjl.juling.module.mes.enums.qc.MesQcCheckResultEnum;
...
import com.lxjl.juling.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import com.lxjl.juling.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public com.lxjl.juling.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return com.lxjl.juling.framework.common.pojo.PageResult.empty();
            }
