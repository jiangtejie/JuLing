package com.lxjl.juling.module.mes.service.wm.outsourcereceipt;
...
import com.lxjl.juling.module.mes.controller.admin.wm.outsourcereceipt.vo.MesWmOutsourceReceiptPageReqVO;
import com.lxjl.juling.module.mes.controller.admin.wm.outsourcereceipt.vo.MesWmOutsourceReceiptSaveReqVO;
...
import com.lxjl.juling.module.mes.dal.dataobject.wm.outsourcereceipt.MesWmOutsourceReceiptDO;
import com.lxjl.juling.module.mes.dal.dataobject.wm.outsourcereceipt.MesWmOutsourceReceiptDetailDO;
import com.lxjl.juling.module.mes.dal.dataobject.wm.outsourcereceipt.MesWmOutsourceReceiptLineDO;
import com.lxjl.juling.module.mes.dal.mysql.wm.outsourcereceipt.MesWmOutsourceReceiptMapper;
import com.lxjl.juling.module.mes.enums.MesBizTypeConstants;
import com.lxjl.juling.module.mes.enums.wm.MesWmOutsourceReceiptStatusEnum;
...
import com.lxjl.juling.module.mes.service.md.vendor.MesMdVendorService;
...
public class MesWmOutsourceReceiptServiceImpl implements MesWmOutsourceReceiptService {
    ...
    public void updateOutsourceReceiptWhenIqcFinish(Long receiptId, Long lineId, Long iqcId,
        ...
        if (unqualifiedQuantity != null && unqualifiedQuantity.compareTo(BigDecimal.ZERO) > 0) {
            ...
            // 原行是从数据库读出来的：清掉被复制过来的审计字段与逻辑删除标记，
            // 否则 PG 下 deleted(Boolean) 写入 smallint 列会报 column "deleted" is of type smallint ...
            unqualifiedLine.clean();
            unqualifiedLine.setDeleted(null);
