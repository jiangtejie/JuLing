...
import com.lxjl.juling.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import com.lxjl.juling.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import com.lxjl.juling.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import com.lxjl.juling.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return com.lxjl.juling.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
