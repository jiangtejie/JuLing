package com.lxjl.juling.module.mes.dal.mysql.pro.task;
...
public interface MesProTaskMapper extends BaseMapperX<MesProTaskDO> {
    ...
    default void updateProducedQuantity(Long id,
        ...
        update(null, new LambdaUpdateWrapper<MesProTaskDO>()
                ...
                .setSql("produced_quantity = COALESCE(produced_quantity, 0) + " + incrProducedQuantity)
                .setSql("qualify_quantity = COALESCE(qualify_quantity, 0) + " + incrQualifyQuantity)
                .setSql("unqualify_quantity = COALESCE(unqualify_quantity, 0) + " + incrUnqualifyQuantity));
    }
