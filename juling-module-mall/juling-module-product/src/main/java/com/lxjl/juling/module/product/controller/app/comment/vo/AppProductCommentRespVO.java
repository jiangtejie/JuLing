package com.lxjl.juling.module.product.controller.app.comment.vo;

import com.lxjl.juling.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductCommentRespVO {
    ...
    @Schema(description = "追评评价图片地址数组，以逗号分隔最多上传 9 张", example = "[上游社区 上游社区")
