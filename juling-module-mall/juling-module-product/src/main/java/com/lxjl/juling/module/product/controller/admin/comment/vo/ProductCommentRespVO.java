package com.lxjl.juling.module.product.controller.admin.comment.vo;
...
public class ProductCommentRespVO {
    ...
    @Schema(description = "评价人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://github.com/jiangtejie/JuLing")
    ...
    @Schema(description = "商品 SKU 图片地址", example = "https://github.com/jiangtejie/JuLing")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED, example = "[上游社区")
