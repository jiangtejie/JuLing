package com.lxjl.juling.module.im.service.statistics;

import com.lxjl.juling.framework.test.core.ut.BaseMockitoUnitTest;
import com.lxjl.juling.module.im.dal.mysql.statistics.ImStatisticsManagerMapper;
...
public class ImStatisticsManagerServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testGetGroupSizeCountMap() {
        when(statisticsMapper.selectGroupSizeDistribution()).thenReturn(Arrays.asList(
                row("size_range", "1-9 人", "count", BigInteger.valueOf(3)),
                row("size_range", "10-49 人", "count", 2)));
