package com.lxjl.juling.framework.jackson.config;

import com.lxjl.juling.framework.common.util.json.JsonUtils;
import com.lxjl.juling.framework.common.util.json.databind.NumberSerializer;
import com.lxjl.juling.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.lxjl.juling.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class JuLingJacksonAutoConfiguration {
