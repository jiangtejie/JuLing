package com.lxjl.juling.framework.encrypt.core.filter;
...
import com.lxjl.juling.framework.encrypt.config.ApiEncryptProperties;
import com.lxjl.juling.framework.encrypt.core.annotation.ApiEncrypt;
...
public class ApiEncryptFilter extends ApiRequestFilter {
    ...
    private ApiEncrypt getApiEncrypt(HttpServletRequest request) {
        try {
            // 特殊：兼容 SpringBoot 2.X 版本会报错的问题 上游社区讨论
