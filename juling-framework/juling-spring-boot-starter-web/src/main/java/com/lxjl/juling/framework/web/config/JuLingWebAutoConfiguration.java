package com.lxjl.juling.framework.web.config;
...
import com.lxjl.juling.framework.web.core.filter.CacheRequestBodyFilter;
import com.lxjl.juling.framework.web.core.filter.DemoFilter;
import com.lxjl.juling.framework.web.core.handler.GlobalExceptionHandler;
import com.lxjl.juling.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class JuLingWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "juling.demo", havingValue = "true")
