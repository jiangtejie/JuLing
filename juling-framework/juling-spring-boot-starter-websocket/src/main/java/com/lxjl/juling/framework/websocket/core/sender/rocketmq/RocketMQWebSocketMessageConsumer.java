package com.lxjl.juling.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${juling.websocket.sender-rocketmq.topic}",
        consumerGroup = "${juling.websocket.sender-rocketmq.consumer-group}",
