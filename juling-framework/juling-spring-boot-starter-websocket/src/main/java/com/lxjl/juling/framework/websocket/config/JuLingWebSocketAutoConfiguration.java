package com.lxjl.juling.framework.websocket.config;

import com.lxjl.juling.framework.mq.redis.config.JuLingRedisMQConsumerAutoConfiguration;
import com.lxjl.juling.framework.mq.redis.core.RedisMQTemplate;
import com.lxjl.juling.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.lxjl.juling.framework.websocket.core.listener.WebSocketMessageListener;
import com.lxjl.juling.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.lxjl.juling.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.lxjl.juling.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.lxjl.juling.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.lxjl.juling.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.lxjl.juling.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.lxjl.juling.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.lxjl.juling.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.lxjl.juling.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.lxjl.juling.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.lxjl.juling.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.lxjl.juling.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.lxjl.juling.framework.websocket.core.session.WebSocketSessionManager;
import com.lxjl.juling.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "juling.websocket", value = "enable", matchIfMissing = true) // 允许使用 juling.websocket.enable=false 禁用 websocket
@EnableConfigurationProperties(WebSocketProperties.class)
public class JuLingWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${juling.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${juling.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${juling.websocket.sender-kafka.topic}") String topic) {
