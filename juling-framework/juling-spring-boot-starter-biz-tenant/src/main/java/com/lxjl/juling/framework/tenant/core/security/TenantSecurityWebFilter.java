package com.lxjl.juling.framework.tenant.core.security;
...
import com.lxjl.juling.framework.web.core.filter.ApiRequestFilter;
...
public class TenantSecurityWebFilter extends ApiRequestFilter {
     ...
     * 允许忽略租户的 URL 列表
     *
     * 目的：解决 <a href="https://github.com/jiangtejie/JuLing">修改配置会导致 @TenantIgnore Controller 接口过滤失效</>
     */
