package com.lxjl.juling.framework.tenant.config;

import com.lxjl.juling.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.lxjl.juling.framework.redis.config.JuLingCacheProperties;
import com.lxjl.juling.framework.security.core.service.SecurityFrameworkService;
import com.lxjl.juling.framework.tenant.core.aop.TenantIgnore;
import com.lxjl.juling.framework.tenant.core.aop.TenantIgnoreAspect;
import com.lxjl.juling.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.lxjl.juling.framework.tenant.core.job.TenantJobAspect;
import com.lxjl.juling.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.lxjl.juling.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.lxjl.juling.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.lxjl.juling.framework.tenant.core.redis.TenantRedisCacheManager;
import com.lxjl.juling.framework.tenant.core.security.TenantSecurityWebFilter;
import com.lxjl.juling.framework.tenant.core.service.TenantFrameworkService;
import com.lxjl.juling.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.lxjl.juling.framework.tenant.core.web.TenantContextWebFilter;
import com.lxjl.juling.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "juling.tenant", value = "enable", matchIfMissing = true) // 允许使用 juling.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class JuLingTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.lxjl.juling.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     JuLingCacheProperties julingCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(julingCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.lxjl.juling.framework.quartz.core.handler.JobHandler")
