 ...
 *      1）Spring Async：
 *          {@link com.lxjl.juling.framework.quartz.config.JuLingAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 JuLingSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.lxjl.juling.framework.tenant;
