package com.lxjl.juling.framework.test.core.util;
...
public class RandomUtils {
    ...
    static {
        ...
        PODAM_FACTORY.getStrategy().addOrReplaceTypeManufacturer(Integer.class, (dataProviderStrategy, attributeMetadata, map) -> {
            // 如果是 deleted 的字段，返回未删除（0）：
            // deleted 列在 PG 生产库是 smallint，随机 int 会超出范围导致插入失败
    ...
    public static String randomURL() {
        return "https://github.com/jiangtejie/JuLing" + randomString();
    }
