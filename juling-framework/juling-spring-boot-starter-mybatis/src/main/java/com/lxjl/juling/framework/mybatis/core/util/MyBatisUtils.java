package com.lxjl.juling.framework.mybatis.core.util;
...
import com.lxjl.juling.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://github.com/jiangtejie/JuLing
        // 排序字段
     ...
     *
     * 使用场景：
     * 1. <a href="https://github.com/jiangtejie/JuLing">fix:修复"商品统计聚合函数的别名与排序字段不符"导致的 SQL 异常</a>
     *
