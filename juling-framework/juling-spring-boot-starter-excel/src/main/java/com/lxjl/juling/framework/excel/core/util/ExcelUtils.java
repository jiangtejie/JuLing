package com.lxjl.juling.framework.excel.core.util;
...
import com.lxjl.juling.framework.excel.core.handler.ColumnWidthMatchStyleStrategy;
import com.lxjl.juling.framework.excel.core.handler.SelectSheetWriteHandler;
...
public class ExcelUtils {
    ...
    public static <T> List<T> read(MultipartFile file, Class<T> head) throws IOException {
        ...
        // 参考 上游社区讨论 帖子，增加 try 处理，兼容 windows 场景
