package com.lxjl.juling.framework.common.util.http;
...
public class HttpUtilsTest {
    ...
    public void testReplaceUrlQuery_replace() {
        // 准备参数
        String url = "https://github.com/jiangtejie/JuLing";
        // 调用
        String result = HttpUtils.replaceUrlQuery(url, "a", "3");
        // 断言：被替换的 key 会移到末尾，原顺序的其它参数保留
        assertEquals("https://github.com/jiangtejie/JuLing?a=3", result);
    }
    ...
    public void testReplaceUrlQuery_add() {
        ...
        // 断言
        assertEquals("https://github.com/jiangtejie/JuLing?b=2", result);
    }
    ...
    public void testReplaceUrlQuery_noQuery() {
        ...
        // 断言
        assertEquals("https://github.com/jiangtejie/JuLing?a=1", result);
    }
    ...
    public void testReplaceUrlQuery_emptyValue() {
        ...
        // 断言：保留 key，value 为空
        assertEquals("https://github.com/jiangtejie/JuLing?a=", result);
    }
