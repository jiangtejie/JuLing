...
import com.lxjl.juling.module.crm.service.customer.CrmCustomerPoolConfigService;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("矩灵").industryId(1).level(1).source(1)
                        .mobile("15601691300").telephone("").qq("").wechat("").email("juling@example.com")
