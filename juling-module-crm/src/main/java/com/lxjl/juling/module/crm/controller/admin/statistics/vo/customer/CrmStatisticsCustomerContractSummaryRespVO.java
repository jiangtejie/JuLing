package com.lxjl.juling.module.crm.controller.admin.statistics.vo.customer;
...
public class CrmStatisticsCustomerContractSummaryRespVO {
    ...
    @Schema(description = "客户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "棱信矩灵")
    ...
    @Schema(description = "负责人", requiredMode = Schema.RequiredMode.REQUIRED, example = "棱信矩灵")
