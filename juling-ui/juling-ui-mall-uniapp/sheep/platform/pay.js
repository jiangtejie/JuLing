...
export default class SheepPay {
  ...
  // 浏览器微信 H5 支付 TODO 棱信矩灵：待接入（注意：H5 支付是给普通浏览器，不是微信公众号的支付，绝大多数人用不到，可以忽略）
  async wechatWapPay() {
  ...
  async alipay() {
    ...
    // TODO @棱信矩灵：【可优化】如果是沙箱支付，EnvUtils.setEnv(EnvUtils.EnvEnum.SANDBOX)，相关 上游社区讨论
    uni.requestPayment({
      provider: 'alipay',
