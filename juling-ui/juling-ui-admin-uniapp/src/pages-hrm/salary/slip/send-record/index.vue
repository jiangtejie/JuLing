    ...
    >
      <view class="p-24rpx">
        ...
        >
          ...
          <view class="yd-text-sub mb-12rpx text-28rpx">
            <text class="yd-text-hint mr-8rpx">发放时间：</text>{{ formatDateTime(item.createTime) || '-' }}
          </view>
          <view class="yd-text-sub mb-12rpx text-28rpx">
            <text class="yd-text-hint mr-8rpx">工资表总人数：</text>{{ item.employeeCount ?? 0 }}
          </view>
          <view class="yd-text-sub text-28rpx">
            <text class="yd-text-hint mr-8rpx">发放人数：</text>{{ item.sendEmployeeCount ?? 0 }}
          </view>
        </view>
      </view>
    </z-paging>
