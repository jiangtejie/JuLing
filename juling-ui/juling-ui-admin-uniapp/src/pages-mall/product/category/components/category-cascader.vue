<template>
  ...
  <view class="yd-search-form-item">
    ...
    <view class="yd-bg-subtle flex items-center justify-between rounded-12rpx p-24rpx" @click="visible = true">
      <text class="text-28rpx" :class="displayText ? 'yd-text-main' : 'yd-text-hint'">
