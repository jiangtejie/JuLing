              ...
              >
                <template #sku="{ row }">
                  <view class="flex items-center gap-12rpx py-8rpx">
                    <text class="yd-text-sub w-160rpx shrink-0 text-26rpx">兑换积分</text>
                    <wd-input-number v-model="row.point" :min="0" />
                  </view>
                  <view class="flex items-center gap-12rpx py-8rpx">
                    <text class="yd-text-sub w-160rpx shrink-0 text-26rpx">兑换金额(元)</text>
                    <wd-input-number v-model="row.price" :min="0" :step="0.01" :precision="2" />
                  </view>
                  <view class="flex items-center gap-12rpx py-8rpx">
                    <text class="yd-text-sub w-160rpx shrink-0 text-26rpx">兑换库存</text>
                    <wd-input-number v-model="row.stock" :min="0" />
                  </view>
                  <view class="flex items-center gap-12rpx py-8rpx">
                    <text class="yd-text-sub w-160rpx shrink-0 text-26rpx">每人限兑</text>
