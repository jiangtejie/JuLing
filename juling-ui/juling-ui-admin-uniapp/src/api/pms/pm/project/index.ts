...
/** 查询项目分页 */
export function getProjectPage(params: PageParam & Record<string, any>) {
  return http.get<PageResult<Project>>('/pms/pm/project/page', params)
}

/** 查询星标项目列表 */
export function getFavoriteProjectList() {
  return http.get<Project[]>('/pms/pm/project/favorite-list')
}

/** 查询项目详情 */
export function getProject(id: number) {
  return http.get<Project>('/pms/pm/project/get', { id })
}

/** 新增项目 */
export function createProject(data: Partial<Project>) {
  return http.post<number>('/pms/pm/project/create', data)
}

/** 修改项目 */
export function updateProject(data: Partial<Project>) {
  return http.put<boolean>('/pms/pm/project/update', data)
}

/** 归档项目 */
export function archiveProject(id: number) {
  return http.put<boolean>('/pms/pm/project/archive', undefined, { id })
}

/** 将项目移入回收站 */
export function recycleProject(id: number) {
  return http.put<boolean>('/pms/pm/project/recycle', undefined, { id })
}

/** 恢复回收站项目 */
export function restoreProject(id: number) {
  return http.put<boolean>('/pms/pm/project/restore', undefined, { id })
}

/** 彻底删除回收站项目 */
export function deleteProject(id: number) {
  return http.delete<boolean>('/pms/pm/project/delete', undefined, { id })
}

/** 查询项目概览 */
export function getProjectOverview(projectId: number) {
  return http.get<ProjectOverview>('/pms/pm/project/overview', { projectId })
}
