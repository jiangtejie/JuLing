<template>
  <view class="yd-bg-subtle shrink-0 px-20rpx pb-[calc(18rpx+env(safe-area-inset-bottom))] pt-10rpx">
    <scroll-view scroll-x class="w-full whitespace-nowrap" :show-scrollbar="false">
      <view class="inline-flex gap-12rpx pb-14rpx pr-20rpx">
        <view
          ...
          :key="word"
          class="yd-text-sub max-w-320rpx truncate rounded-full bg-white px-22rpx py-12rpx text-23rpx shadow-[0_4rpx_18rpx_rgba(0,0,0,0.04)]"
