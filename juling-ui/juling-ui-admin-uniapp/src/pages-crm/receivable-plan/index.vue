    ...
    >
      <view class="p-24rpx">
        <view v-for="item in list" :key="item.id" class="mb-24rpx rounded-12rpx bg-white p-24rpx shadow-sm" @click="handleDetail(item)">
          ...
          <view v-if="item.contractNo" class="yd-text-sub mb-12rpx text-28rpx">
            <text class="yd-text-hint mr-8rpx">合同编号：</text>{{ item.contractNo }}
          </view>
          <view v-if="item.period !== undefined && item.period !== null" class="yd-text-sub mb-12rpx text-28rpx">
            <text class="yd-text-hint mr-8rpx">期数：</text>{{ item.period }}
          </view>
          <view v-if="item.price !== undefined && item.price !== null" class="yd-text-sub mb-12rpx text-28rpx">
