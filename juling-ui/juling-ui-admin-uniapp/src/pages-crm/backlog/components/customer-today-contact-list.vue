...
import { buildDefaultFilters, CONTACT_STATUS, SCENE_TYPES } from './common'
...
async function queryList(pageNo: number, pageSize: number) {
  try {
    const data = await getCustomerPage({ pageNo, pageSize, pool: null, ...filterValues.value })
