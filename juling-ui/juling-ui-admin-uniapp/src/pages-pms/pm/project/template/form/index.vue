<template>
  <view class="yd-page-container">
        ...
        <view class="tpl-board-drop">
          ...
          >
            <view class="yd-text-main mb-8rpx text-28rpx">
              ...
              <text class="yd-text-hint text-24rpx">
                （{{ board.code || "-" }} ·
                {{ getWorkItemTypeName(board.workItemType) }}）
              </text>
            </view>
            <view class="yd-text-hint mb-12rpx text-24rpx">
    ...
    <!-- 状态编辑弹窗 -->
    <wd-popup v-model="statusVisible" position="bottom" safe-area-inset-bottom root-portal>
      <view class="p-32rpx">
    ...
    <!-- 看板列编辑弹窗 -->
    <wd-popup v-model="boardVisible" position="bottom" safe-area-inset-bottom root-portal>
      <view class="p-32rpx">
        <view class="yd-text-main mb-24rpx text-center text-32rpx font-semibold">
          编辑看板列
        </view>
