      ...
      >
        <view class="p-24rpx pb-200rpx">
          ...
          <view class="mb-24rpx rounded-12rpx bg-white p-24rpx shadow-sm">
            <view class="yd-text-sub mb-12rpx flex justify-between text-28rpx">
              <text>迭代进度</text>
          ...
          <view class="mt-24rpx rounded-12rpx bg-white p-24rpx shadow-sm">
            ...
            >
              <text class="yd-text-sub w-96rpx shrink-0 text-26rpx">
                {{
                  item.name
                }}
              </text>
              ...
              />
              <text
                class="yd-text-main w-48rpx shrink-0 text-right text-26rpx font-semibold"
              >
                {{ item.count }}
              </text>
            </view>
          ...
          <view class="mt-24rpx rounded-12rpx bg-white p-24rpx shadow-sm">
            ...
            <template v-else>
              ...
              >
                ...
                >
                  <text class="yd-text-sub">{{ row.name }}</text>
          ...
          >
            <view class="mb-16rpx flex items-center justify-between">
              ...
              <text class="yd-text-hint text-24rpx">柱形为每日已完成事项数</text>
            </view>
            <TrendBars
            ...
            <view
              ...
              class="yd-text-sub mt-8rpx text-24rpx"
            >
          ...
          >
            <view class="mb-16rpx flex items-center justify-between">
              ...
              <text class="yd-text-hint text-24rpx">柱形为每日实际剩余工时</text>
            </view>
            ...
            <view v-if="latestBurnDown" class="yd-text-sub mt-8rpx text-24rpx">
