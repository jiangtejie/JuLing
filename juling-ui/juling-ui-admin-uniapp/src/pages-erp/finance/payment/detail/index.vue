        ...
        <view class="px-24rpx">
          ...
          >
            ...
            <view class="yd-text-sub mb-10rpx flex text-26rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">采购单据编号：</text>
              <text class="min-w-0 flex-1">{{ item.bizNo || '-' }}</text>
            </view>
            <view class="yd-text-sub mb-10rpx flex text-26rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">采购业务类型：</text>
              <text class="min-w-0 flex-1">{{ getBizTypeName(item.bizType) }}</text>
            </view>
            <view class="yd-text-sub mb-10rpx flex text-26rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">应付金额：</text>
              <text class="min-w-0 flex-1">{{ formatMoney(item.totalPrice) }}</text>
            </view>
            <view class="yd-text-sub mb-10rpx flex text-26rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">已付金额：</text>
              <text class="min-w-0 flex-1">{{ formatMoney(item.paidPrice) }}</text>
            </view>
            <view class="yd-text-sub mb-10rpx flex text-26rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">本次付款：</text>
