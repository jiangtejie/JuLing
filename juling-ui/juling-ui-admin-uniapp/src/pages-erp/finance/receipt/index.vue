        ...
        >
          <view>
            <view class="p-24rpx">
              ...
              <view class="yd-text-sub mb-12rpx text-28rpx">
                <text class="yd-text-hint mr-8rpx">收款时间：</text>{{ formatDateTime(item.receiptTime) || '-' }}
              </view>
              ...
              <view class="yd-text-sub flex text-28rpx">
                ...
                <view class="flex-1">
                  <text class="yd-text-hint mr-8rpx">实收：</text>{{ formatMoney(item.receiptPrice) }}
                </view>
              </view>
            </view>
          </view>
...
import { getFinanceReceiptPage } from '@/api/erp/finance/receipt'
...
const list = ref<FinanceReceipt[]>([]) // 列表数据
