...
const list = ref<PurchaseReturn[]>([]) // 可退款采购退货列表
const selectedRows = ref<PurchaseReturn[]>([]) // 已选采购退货
const pagingRef = ref<ZPagingRef<PurchaseReturn>>() // 分页组件引用
