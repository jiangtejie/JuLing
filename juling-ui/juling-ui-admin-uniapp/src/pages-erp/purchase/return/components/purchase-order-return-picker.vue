        ...
        <view class="p-24rpx">
          ...
          >
            ...
            <view class="yd-text-sub flex text-26rpx">
              <view class="flex-1">
                <text class="yd-text-hint mr-8rpx">已入库：</text>{{ formatCount(item.inCount) }}
              </view>
              <view class="flex-1">
                <text class="yd-text-hint mr-8rpx">已退货：</text>{{ formatCount(item.returnCount) }}
              </view>
            </view>
          </view>
        </view>
...
const list = ref<PurchaseOrder[]>([]) // 可退货订单列表
