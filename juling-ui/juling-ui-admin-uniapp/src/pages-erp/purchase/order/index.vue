          ...
          <view>
            <view class="p-24rpx">
              ...
              <view class="yd-text-sub mb-12rpx flex text-28rpx">
                ...
                <view class="flex-1">
                  <text class="yd-text-hint mr-8rpx">入库：</text>{{ formatCount(item.inCount) }}
                </view>
              </view>
              <view class="yd-text-sub flex text-28rpx">
                <view class="flex-1">
                  <text class="yd-text-hint mr-8rpx">含税金额：</text>{{ formatMoney(item.totalPrice) }}
                </view>
                <view class="flex-1">
                  <text class="yd-text-hint mr-8rpx">订金：</text>{{ formatMoney(item.depositPrice) }}
                </view>
              </view>
            </view>
          </view>
...
const list = ref<PurchaseOrder[]>([]) // 列表数据
