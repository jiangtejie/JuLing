    ...
    >
      <view class="px-24rpx py-8rpx">
        ...
        >
          ...
          <view class="yd-text-sub mb-8rpx flex text-26rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">故障描述：</text>
            <text class="min-w-0 flex-1 truncate">{{ item.malfunction || '-' }}</text>
          </view>
          <view v-if="item.malfunctionUrl" class="yd-text-sub mb-8rpx flex text-26rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">故障图片：</text>
            <wd-img
          ...
          <view class="yd-text-sub mb-8rpx flex text-26rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">维修描述：</text>
