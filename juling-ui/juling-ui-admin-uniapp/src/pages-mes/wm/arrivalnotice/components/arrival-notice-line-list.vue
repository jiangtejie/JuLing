    ...
    >
      <view class="px-24rpx py-8rpx">
        ...
        >
          ...
          <view class="yd-text-sub mb-8rpx flex text-26rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">到货数量：</text>
            <text class="min-w-0 flex-1 truncate">{{ item.arrivalQuantity ?? '-' }}</text>
          </view>
          <view class="yd-text-sub mb-8rpx flex text-26rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">合格数量：</text>
            <text class="min-w-0 flex-1 truncate">{{ item.qualifiedQuantity ?? '-' }}</text>
          </view>
          <view class="yd-text-sub mb-8rpx flex text-26rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">检验单号：</text>
