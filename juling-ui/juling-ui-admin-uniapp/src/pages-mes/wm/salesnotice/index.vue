        ...
        >
          <view class="p-24rpx">
            ...
            <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">销售订单编号：</text>
              <text class="min-w-0 flex-1 truncate">{{ item.salesOrderCode || '-' }}</text>
            </view>
            <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">客户编码：</text>
            ...
            <view class="yd-text-sub flex items-center text-28rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">发货日期：</text>
...
const list = ref<WmSalesNotice[]>([]) // 列表数据
...
/** 查看详情 */
function handleDetail(item: WmSalesNotice) {
  uni.navigateTo({
