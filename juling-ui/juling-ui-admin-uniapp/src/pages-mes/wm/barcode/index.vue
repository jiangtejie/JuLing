      ...
      <view class="p-24rpx">
        ...
        >
          <view class="p-24rpx">
            ...
            <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">条码内容：</text>
              <text class="min-w-0 flex-1 truncate">{{ item.content || '-' }}</text>
            </view>
            <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">业务编码：</text>
              <text class="min-w-0 flex-1 truncate">{{ item.bizCode || '-' }}</text>
            </view>
            <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
              <text class="yd-text-hint mr-8rpx shrink-0">业务名称：</text>
