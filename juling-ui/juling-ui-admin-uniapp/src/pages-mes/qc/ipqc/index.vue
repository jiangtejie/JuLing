    ...
    >
      <view class="p-24rpx">
        ...
        >
          ...
          <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">生产工单：</text>
            <text class="min-w-0 flex-1 truncate">{{ item.workOrderCode || '-' }} / {{ item.workOrderName || '-' }}</text>
          </view>
          <view class="yd-text-sub mb-12rpx flex items-center text-28rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">工位工序：</text>
            <text class="min-w-0 flex-1 truncate">{{ item.workstationName || '-' }} / {{ item.processName || '-' }}</text>
          </view>
          <view v-if="item.taskId" class="yd-text-sub mb-12rpx flex items-center text-28rpx">
            <text class="yd-text-hint mr-8rpx shrink-0">生产任务：</text>
