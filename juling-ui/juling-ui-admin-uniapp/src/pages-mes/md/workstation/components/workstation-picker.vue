  ...
  >
    <view class="yd-bg-page h-full flex flex-col">
      ...
      <view class="bg-white px-24rpx pb-20rpx">
        <wd-input v-model="queryParams.code" placeholder="工作站编码" clearable />
        <wd-input v-model="queryParams.name" placeholder="工作站名称" clearable class="mt-12rpx" />
...
/** 选择工作站 */
function handleSelect(item: MdWorkstation) {
  selected.value = item
  pendingSelectedId.value = undefined
}
