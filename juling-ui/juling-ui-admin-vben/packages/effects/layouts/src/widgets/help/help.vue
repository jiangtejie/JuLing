...
const PROJECT_URL = 'https://github.com/jiangtejie/JuLing';
    ...
    <div class="mt-2 flex flex-col">
      <div class="mt-2 flex flex-col">
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton variant="link" @click="openWindow(PROJECT_URL)">
            Github
          </VbenButton>
        </VbenButtonGroup>
        ...
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton
            variant="link"
            @click="openWindow(`${PROJECT_URL}/issues`)"
          >
            Github
          </VbenButton>
        </VbenButtonGroup>
        ...
        <VbenButtonGroup class="basis-1/3" :gap="2" border size="large">
          ...
          <VbenButton
            variant="link"
            @click="openWindow(`${PROJECT_URL}#readme`)"
          >
            项目文档
          </VbenButton>
