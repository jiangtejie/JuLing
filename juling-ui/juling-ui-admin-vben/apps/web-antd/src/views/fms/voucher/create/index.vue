            ...
            >
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="entry-subject relative !px-10px" :class="{ '!pb-[18px]': entry.subjectId }">
                    <div
                      v-if="readOnly"
                      class="flex min-h-[60px] items-center px-[2px] leading-[20px]"
                    >
                    ...
                    <div
                      ...
                      class="subject-balance pointer-events-none absolute bottom-[1px] left-[10px] hidden text-[12px] leading-[14px] whitespace-nowrap tabular-nums text-[var(--el-text-color-placeholder)]"
                    >
