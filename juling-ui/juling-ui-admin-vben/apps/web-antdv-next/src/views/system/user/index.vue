...
<template>
  <Page auto-content-height>
    <template #doc>
      <DocAlert title="用户体系" url="https://github.com/jiangtejie/JuLing#readme" />
      <DocAlert title="三方登陆" url="https://github.com/jiangtejie/JuLing#readme" />
      <DocAlert
        title="Excel 导入导出"
    ...
    <div class="flex h-full w-full">
      <!-- 左侧部门树 -->
      <Card
        class="mr-4 h-full w-1/6 overflow-hidden [&_.ant-card-body]:flex [&_.ant-card-body]:h-full [&_.ant-card-body]:min-h-0 [&_.ant-card-body]:flex-col"
      >
