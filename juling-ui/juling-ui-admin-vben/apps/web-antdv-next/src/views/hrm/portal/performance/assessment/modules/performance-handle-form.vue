...
import { Button, Descriptions, DescriptionsItem, message } from 'antdv-next';
...
<template>
  <Modal :title="title" class="w-[900px]">
    ...
    <template #footer>
      ...
      <Button danger @click="submitForm(false)">驳回</Button>
      <Button type="primary" @click="submitForm(true)">通过</Button>
    </template>
  </Modal>
</template>
