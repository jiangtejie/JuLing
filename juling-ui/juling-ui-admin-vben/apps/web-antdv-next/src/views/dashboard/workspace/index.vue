...
const projectItems: WorkbenchProjectItem[] = [
  {
    color: '#6DB33F',
    content: 'github.com/jiangtejie/JuLing',
    date: '2025-01-02',
    group: 'Spring Boot 单体架构',
    icon: 'simple-icons:springboot',
    title: '矩灵管理系统',
    url: 'https://github.com/jiangtejie/JuLing',
  },
  {
    color: '#409EFF',
    content: 'github.com/jiangtejie/JuLing',
