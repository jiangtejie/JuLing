...
import com.lxjl.juling.module.fms.controller.admin.config.vo.digest.FmsDigestSaveReqVO;
import com.lxjl.juling.module.fms.dal.dataobject.config.FmsDigestDO;
import com.lxjl.juling.module.fms.dal.mysql.config.FmsDigestMapper;
...
import static com.lxjl.juling.module.fms.enums.ErrorCodeConstants.DIGEST_NOT_EXISTS;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_CREATE_SUB_TYPE;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_CREATE_SUCCESS;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_DELETE_SUB_TYPE;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_DELETE_SUCCESS;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_TYPE;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_UPDATE_SUB_TYPE;
import static com.lxjl.juling.module.fms.enums.LogRecordConstants.FMS_DIGEST_UPDATE_SUCCESS;
