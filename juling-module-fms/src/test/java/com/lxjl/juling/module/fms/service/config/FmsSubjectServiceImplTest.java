...
import com.lxjl.juling.module.fms.service.config.FmsCurrencyService;
...
import com.lxjl.juling.module.fms.service.config.FmsVoucherTemplateService;
...
public class FmsSubjectServiceImplTest extends BaseDbUnitTest {
    ...
    @Test
    public void testInitializeDefaultSubjects_templateEmpty() {
        // 准备参数：不插入任何 fms_subject_template 数据

        // 调用，并断言：直接抛「标准科目模板为空」，而不是让后续结账模板初始化报出难以定位的缺科目错误
        assertServiceException(() -> subjectService.initializeDefaultSubjects(10L), SUBJECT_TEMPLATE_EMPTY);
    }
