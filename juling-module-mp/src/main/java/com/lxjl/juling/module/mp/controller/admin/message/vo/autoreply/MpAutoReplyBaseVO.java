package com.lxjl.juling.module.mp.controller.admin.message.vo.autoreply;
...
public class MpAutoReplyBaseVO {
    ...
    @Schema(description = "回复的媒体 URL", example = "https://github.com/jiangtejie/JuLing")
    @NotEmpty(message = "回复的消息 mediaId 不能为空",
            groups = {ImageMessageGroup.class, VoiceMessageGroup.class, VideoMessageGroup.class})
    ...
    @Schema(description = "缩略图的媒体 URL",example = "https://github.com/jiangtejie/JuLing")
    ...
    @Schema(description = "回复的音乐链接", example = "https://github.com/jiangtejie/JuLing")
    ...
    @Schema(description = "高质量音乐链接", example = "https://github.com/jiangtejie/JuLing")
