package com.lxjl.juling.module.mp.controller.admin.menu.vo;
...
import static com.lxjl.juling.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://github.com/jiangtejie/JuLing")
