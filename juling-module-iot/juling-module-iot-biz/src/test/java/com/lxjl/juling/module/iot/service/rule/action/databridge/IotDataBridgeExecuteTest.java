package com.lxjl.juling.module.iot.service.rule.action.databridge;
...
import com.lxjl.juling.module.iot.dal.dataobject.rule.config.*;
import com.lxjl.juling.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("https://github.com/jiangtejie/JuLing#readme").setMethod(HttpMethod.GET.name());
