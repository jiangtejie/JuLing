package com.lxjl.juling.module.iot.controller.admin.product.vo.product;
...
import com.lxjl.juling.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "产品图标", example = "https://github.com/jiangtejie/JuLing")
    private String icon;

    @Schema(description = "产品图片", example = "https://github.com/jiangtejie/JuLing")
