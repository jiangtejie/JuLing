package com.lxjl.juling.module.iot.controller.admin.ota.vo.firmware;
...
public class IotOtaFirmwareCreateReqVO {
    ...
    @Schema(description = "固件文件 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://github.com/jiangtejie/JuLing")
