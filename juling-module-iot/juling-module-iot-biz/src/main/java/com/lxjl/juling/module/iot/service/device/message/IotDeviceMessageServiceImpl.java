package com.lxjl.juling.module.iot.service.device.message;
...
import com.lxjl.juling.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import com.lxjl.juling.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import com.lxjl.juling.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
import com.lxjl.juling.module.iot.core.topic.event.IotDeviceEventPostReqDTO;
import com.lxjl.juling.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import com.lxjl.juling.module.iot.core.topic.property.IotDevicePropertyPostReqDTO;
...
import com.lxjl.juling.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import com.lxjl.juling.module.iot.dal.tdengine.IotDeviceMessageMapper;
import com.lxjl.juling.module.iot.service.device.IotDeviceService;
import com.lxjl.juling.module.iot.service.device.property.IotDevicePropertyService;
import com.lxjl.juling.module.iot.service.ota.IotOtaTaskRecordService;
...
import static com.lxjl.juling.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO 棱信矩灵：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @棱信矩灵：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
