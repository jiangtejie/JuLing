package com.lxjl.juling.module.iot.job.device;
...
import com.lxjl.juling.module.iot.framework.iot.config.JuLingIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private JuLingIotProperties iotProperties;
