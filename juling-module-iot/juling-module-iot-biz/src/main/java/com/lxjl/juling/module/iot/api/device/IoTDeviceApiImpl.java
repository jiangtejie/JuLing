package com.lxjl.juling.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.lxjl.juling.framework.common.enums.RpcConstants;
...
import com.lxjl.juling.module.iot.core.biz.dto.*;
...
import com.lxjl.juling.module.iot.dal.dataobject.device.IotDeviceModbusConfigDO;
import com.lxjl.juling.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import com.lxjl.juling.module.iot.dal.dataobject.product.IotProductDO;
import com.lxjl.juling.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 juling-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
