package com.lxjl.juling.module.iot.core.messagebus.config;

import com.lxjl.juling.framework.mq.redis.core.RedisMQTemplate;
import com.lxjl.juling.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.lxjl.juling.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.lxjl.juling.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.lxjl.juling.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.lxjl.juling.module.iot.core.messagebus.core.IotMessageBus;
import com.lxjl.juling.module.iot.core.messagebus.core.kafka.IotKafkaMessageBus;
import com.lxjl.juling.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.lxjl.juling.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import com.lxjl.juling.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.lxjl.juling.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import com.lxjl.juling.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.iot.message-bus", name = "type", havingValue = "kafka")
    ...
    /**
     * 特殊：由于 JuLingRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.lxjl.juling.framework.mq.redis.config.JuLingRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "juling.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "juling.iot.message-bus", name = "type", havingValue = "rabbitmq")
