package com.lxjl.juling.module.iot.core.messagebus.core.rocketmq;

import cn.hutool.core.util.IdUtil;
import com.lxjl.juling.module.iot.core.messagebus.config.IotMessageBusAutoConfiguration;
...
import com.lxjl.juling.module.iot.core.messagebus.core.TestMessage;
...
@TestPropertySource(properties = {
        "juling.iot.message-bus.type=rocketmq",
...
//                return "test-topic-consumer-01";
    ...
    public void testSendMessageWithTwoSubscribers() throws InterruptedException {
        ...
        String topic = "test-topic-" + IdUtil.simpleUUID();
//        String topic = "test-topic-pojo";
        TestMessage testMessage = new TestMessage().setNickname("juling").setAge(18);
        // 用于等待消息处理完成
