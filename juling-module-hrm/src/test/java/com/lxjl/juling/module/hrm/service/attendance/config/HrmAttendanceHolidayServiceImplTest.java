...
import com.lxjl.juling.module.hrm.controller.admin.attendance.vo.holiday.HrmAttendanceHolidaySaveReqVO;
import com.lxjl.juling.module.hrm.dal.dataobject.attendance.config.HrmAttendanceHolidayDO;
import com.lxjl.juling.module.hrm.dal.mysql.attendance.config.HrmAttendanceHolidayMapper;
...
import static com.lxjl.juling.module.hrm.enums.ErrorCodeConstants.ATTENDANCE_HOLIDAY_DATE_DUPLICATE;
import static com.lxjl.juling.module.hrm.enums.ErrorCodeConstants.ATTENDANCE_HOLIDAY_NOT_EXISTS;
...
public class HrmAttendanceHolidayServiceImplTest extends BaseDbUnitTest {
    ...
    private HrmAttendanceHolidayDO randomAttendanceHoliday(LocalDateTime date, Integer type) {
        return randomPojo(HrmAttendanceHolidayDO.class,
                o -> o.setId(null).setDate(date.toLocalDate().atStartOfDay()).setType(type).setDeleted(0));
    }
