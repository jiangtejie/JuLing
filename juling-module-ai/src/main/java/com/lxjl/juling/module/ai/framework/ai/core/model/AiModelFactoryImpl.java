package com.lxjl.juling.module.ai.framework.ai.core.model;
...
import com.lxjl.juling.framework.common.util.spring.SpringUtils;
import com.lxjl.juling.module.ai.enums.model.AiPlatformEnum;
import com.lxjl.juling.module.ai.framework.ai.config.AiAutoConfiguration;
import com.lxjl.juling.module.ai.framework.ai.config.JuLingAiProperties;
...
import com.lxjl.juling.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.lxjl.juling.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
import com.lxjl.juling.module.ai.util.AiUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            JuLingAiProperties.Midjourney properties = SpringUtil.getBean(JuLingAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        JuLingAiProperties.YiYan properties = new JuLingAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(JuLingAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        JuLingAiProperties.DouBao properties = new JuLingAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(JuLingAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        JuLingAiProperties.HunYuan properties = new JuLingAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(JuLingAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        JuLingAiProperties.SiliconFlow properties = new JuLingAiProperties.SiliconFlow()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#zhiPuChatClient(JuLingAiProperties)}
     */
    private ZhiPuChatModel buildZhiPuChatModel(String apiKey, String url) {
        JuLingAiProperties.ZhiPu properties = new JuLingAiProperties.ZhiPu()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildZhiPuChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#miniMaxChatClient(JuLingAiProperties)}
     */
    private MiniMaxChatModel buildMiniMaxChatModel(String apiKey, String url) {
        JuLingAiProperties.MiniMax properties = new JuLingAiProperties.MiniMax()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildMiniMaxChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#moonshotChatClient(JuLingAiProperties)}
     */
    private MoonshotChatModel buildMoonshotChatModel(String apiKey, String url) {
        JuLingAiProperties.Moonshot properties = new JuLingAiProperties.Moonshot()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildMoonshotChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#stepFunChatClient(JuLingAiProperties)}
     */
    private StepFunChatModel buildStepFunChatModel(String apiKey, String url) {
        JuLingAiProperties.StepFun properties = new JuLingAiProperties.StepFun()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildStepFunChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(JuLingAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String apiKey) {
        JuLingAiProperties.XingHuo properties = new JuLingAiProperties.XingHuo()
                .setApiKey(apiKey).setModel(XingHuoChatModel.MODEL_DEFAULT);
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(JuLingAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        JuLingAiProperties.BaiChuan properties = new JuLingAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(JuLingAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        JuLingAiProperties.Gemini properties = SpringUtil.getBean(JuLingAiProperties.class)
    ...
    private GrokChatModel buildGrokChatModel(String apiKey, String url) {
        JuLingAiProperties.Grok properties = new JuLingAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
