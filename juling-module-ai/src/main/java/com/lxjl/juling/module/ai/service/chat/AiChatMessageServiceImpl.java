package com.lxjl.juling.module.ai.service.chat;
...
import com.lxjl.juling.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.lxjl.juling.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.lxjl.juling.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.lxjl.juling.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.lxjl.juling.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.lxjl.juling.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.lxjl.juling.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.lxjl.juling.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.lxjl.juling.module.ai.dal.dataobject.model.AiModelDO;
import com.lxjl.juling.module.ai.dal.dataobject.model.AiToolDO;
import com.lxjl.juling.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.lxjl.juling.module.ai.enums.ErrorCodeConstants;
...
import com.lxjl.juling.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.lxjl.juling.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.lxjl.juling.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.lxjl.juling.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.lxjl.juling.module.ai.service.model.AiChatRoleService;
import com.lxjl.juling.module.ai.service.model.AiModelService;
import com.lxjl.juling.module.ai.service.model.AiToolService;
import com.lxjl.juling.module.ai.util.AiUtils;
import com.lxjl.juling.module.ai.util.FileTypeUtils;
...
import static com.lxjl.juling.framework.common.pojo.CommonResult.error;
...
import static com.lxjl.juling.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.lxjl.juling.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 juling.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 juling.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
