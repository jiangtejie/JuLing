package com.lxjl.juling.module.erp.controller.admin.stock.vo.out;
...
import static com.lxjl.juling.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "矩灵")
    @ExcelProperty("客户名称")
